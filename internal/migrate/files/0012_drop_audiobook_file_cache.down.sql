-- Restores the audiobook_file_cache table at its 0004-vintage shape so a
-- down-migrate round-trip is reversible. The Go store helpers that used to
-- read/write this table are gone; this down-migrate is only useful for
-- operators rolling back to a pre-streaming-rewrite plugin binary.
