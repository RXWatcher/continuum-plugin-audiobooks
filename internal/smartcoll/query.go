...
// series, year, rating, language, duration_seconds, ...).
//
// All evaluation happens Go-side: the plugin fetches a page of
// LibraryItems from the configured backend and walks the rule tree in
// memory. SQL pushdown is a follow-up once libraries grow past a few
// thousand items.
package smartcoll
