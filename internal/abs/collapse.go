...
// seriesKey prefers the id (stable identifier from the backend); falls
// back to the name when the id is empty (legacy backends).
...
// emits for series — "The Stormlight Archive" sorts under S, not T. We
// strip a handful of common English articles; matches real ABS's
// behavior closely enough for client-side sort to be sensible.
